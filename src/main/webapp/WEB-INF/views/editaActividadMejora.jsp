...
<body>
	<div class="container">
		...
		<form:form action="${pageContext.request.contextPath}/guardarEditActividadMejora" method="post">
			<input type="hidden" name="idactividadmejora" value="${model.ac.getIdactividadmejora()}">
			<div class="row">
				<div class="col-3">Nombre:</div>
				<div class="col-7">
					<input class="form-control" type="text" name="nombre" value="${model.ac.getNombre()}" />
				</div>
			</div>
			<hr>
			<div class="row">
					...
					<select name="profesional.id_profesional" class="form-control form-control">
						<c:forEach items="${model.listap}" var="profesional">
							<option value="${profesional.getId_profesional()}"
								${model.ac.getProfesional().getId_profesional()==profesional.getId_profesional()
			...
			<div class="row">
				<div class="col-1"><a class="btn btn-secondary"
						href="${pageContext.request.contextPath}/listarActividadMejora">Volver</a></div>
